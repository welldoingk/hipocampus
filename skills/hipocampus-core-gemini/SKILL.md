...
description: "3-tier agent memory system with 5-level compaction tree. Gemini CLI version. Defines session start protocol, end-of-task checkpoints, and memory file management. MUST be followed every session."
---

# Hipocampus — Agent Memory Protocol (Gemini CLI)
...
MEMORY.md and USER.md are loaded by the platform via GEMINI.md. memory/ROOT.md is available via the Compaction Root section in MEMORY.md.
